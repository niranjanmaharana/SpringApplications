...
<div class="app-title">
	...
	<ul class="app-breadcrumb breadcrumb side">
		...
		<li class="breadcrumb-item active"><a href="#">Create Device</a></li>
	</ul>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="tile">
			<div class="tile-body">
				<table class="table table-hover table-bordered" id="sampleTable">
					...
					<tbody>
					<c:forEach items="${deviceList}" var="deviceList" varStatus="loop">
						<tr>
							<td align="center">${loop.index + 1}</td>
							<td align="center">${deviceList.deviceName}</td>
							<td align="center">${deviceList.uniqueDeviceId}</td>
							<td align="center">${deviceList.user.firstName}</td>
							<td align="center"><a
								href="${pageContext.request.contextPath}/device/edit?id=${deviceList.deviceId}"><i
									class="fa fa-edit"></i></a></td>
							<td align="center"><a
								href="#" ><i id="device_${deviceList.deviceId}"
		...
		$(".btnDelete").on("click",function(){
			var deviceId = $(this).attr("id").split("_")[1];
		 	swal({
	      		...
	      		if (isConfirm) {
	      			window.location.href = contextPath+"/device/delete?id="+deviceId;
	      		} else {
	      			swal.close();
	      		}
	      	});
