		...
		<div class="tile">
			<div class="tile-body">
				<table class="table table-hover table-bordered" id="sampleTable">
					...
					<tbody>
					<c:forEach items="${userRole}" var="userRole" varStatus="loop">
						<tr>
							<td align="center">${loop.index + 1}</td>
							<td align="center">${userRole.userRole}</td>
							<td align="center"><a
								href="${pageContext.request.contextPath}/role/edit?id=${userRole.roleId}"><i
									class="fa fa-edit"></i></a></td>
							<td align="center"><a
								href="#" ><i id="role_${userRole.roleId}"
		...
		$("#sampleTable").on("click",'.btnDelete',function(){
			...
			console.log(roleId)
		 	swal({
	      		...
	      		if (isConfirm) {
	      			window.location.href = contextPath+"/role/delete?id="+roleId;
