      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <form:form method="post" name="clinicform" action="${pageContext.request.contextPath}/clinic/update" commandName="clinicInformation">
              <div align="right"><a href="#" data-toggle="modal" data-target="#textModal" id="helpModal">Have trouble for finding area!</a></div>
				<div class="row">
                <div class="form-group col-md-6">
					<label class="control-label">Clinic Name</label>
					<form:input class="form-control" type="text" placeholder="Enter Clinic name" path="clincName"/>
						<form:input type="hidden" path="clinicId" class="form-control"/>
				</div>
				<div class="form-group col-md-6">
					<label class="control-label">Area Name</label>
					<form:select id="inputImplementation" class="form-control" path="implementation.areaId" items="${implementationList}" itemValue="areaId" itemLabel="areaName">
					</form:select>
				</div>
				</div>
                <div class="row">
                ...
                <div class="form-group col-md-6">
					...
					<form:textarea class="form-control" placeholder="Enter full Address" path="address"/>
				</div>	
                </div>
				<div class="tile-footer">
            	  <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>update</button>&nbsp;&nbsp;&nbsp;
            	  <a class="btn btn-secondary" href="${pageContext.request.contextPath}/clinic/view"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            	</div>
            	</form:form>
