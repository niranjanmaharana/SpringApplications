...
<div class="app-title">
	...
	<ul class="app-breadcrumb breadcrumb side">
		...
		<li class="breadcrumb-item active"><a href="${pageContext.request.contextPath}/country/load">Cerate Country</a></li>
	</ul>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="tile">
			<div class="tile-body">
				<table class="table table-hover table-bordered" id="sampleTable">
					...
					<tbody>
					<c:forEach items="${countryList}" var="countryList" varStatus="loop">
						<tr>
							<td align="center">${loop.index + 1}</td>
							<td align="center">${countryList.name}</td>
							<td align="center"><a
								href="${pageContext.request.contextPath}/country/edit?id=${countryList.id}"><i
									class="fa fa-edit"></i></a></td>
							<td align="center"><a
								href="#" ><i id="education_${countryList.id}"
		...
		$("#sampleTable").on("click",'.btnDelete',function(){
			var educationId = $(this).attr("id").split("_")[1];
		 	swal({
	      		...
	      		if (isConfirm) {
	      			window.location.href = contextPath+"/country/delete?id="+educationId;
