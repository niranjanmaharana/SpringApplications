      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="tile">
            ...
            <div class="tile-body">
              <form:form method="post" name="postform" action="${pageContext.request.contextPath}/post/insert" commandName="post" enctype="multipart/form-data">
				<div class="row">
				...
				<div id="postContentInfo" style="display:none">
				<div class="row">
				<div class="form-group col-md-6">
