				...
				<table class="table table-hover table-bordered" id="sampleTable">
					...
					<c:forEach items="${userList}" var="userList" varStatus="loop">
						<tr>
							...
							<td align="center">${userList.practiceInfo.clinic.clincName}</td>
							<td align="center"><a
								href="${pageContext.request.contextPath}/user/editDoctor?id=${userList.userId}"><i
		...
		$("#sampleTable").on("click",'.btnDelete',function(){
			var userId = $(this).attr("id").split("_")[1];
		 	swal({
	      		...
	      		if (isConfirm) {
	      			window.location.href = contextPath+"/user/deleteDoctor?id="+userId;
